...
/**
 * Created by Bharani on 10/22/17.
 */
...
/*
        ...
        TileView tileView = new TileView( getActivity().getApplicationContext() );
        tileView.setSize( 3309, 2339 );  // the original size of the untiled image
        tileView.addDetailLevel( 1f, "plan/0/1000/%d-%d.png");
        tileView.addDetailLevel( 0.5f, "plan/0/500/%d-%d.png");
        tileView.addDetailLevel( 0.25f, "plan/0/250/%d-%d.png");
